...
namespace BLEProgram
{
    ...
    public class NrfUuid
    {
        ...
        public static Guid UNKNOWN_SERVICE_UUID = Guid.Parse("0000beef-1212-efde-1523-785fef13d123");
        public static Guid UNKNOWN_CHAR_UUID = Guid.Parse("0000beef-1212-efde-1523-785fef13d123");
    }
}
